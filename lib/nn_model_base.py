...
from config.param import IS_TRAIN, INPUT_SHAPE, measure_dict, RANDOM_STATE
...
class NN:
    ...
    def test_in_batch(self, x, y_ont_hot, name='val'):
        ...
        batch_size = self.params['batch_size']
        steps = math.ceil(len(y_ont_hot) * 1.0 / batch_size)
    ...
    def gen_model_from_layer(self, start_layer_index, end_layer_index, with_input=True):
        ...
        return keras.models.Sequential(model_list)
